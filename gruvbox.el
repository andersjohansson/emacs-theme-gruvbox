...
(defmacro gruvbox-deftheme (name description palette &rest body)
  `(autothemer-deftheme
    ...
    ((default                                   (:background gruvbox-bg :foreground gruvbox-light0))
     ...
     (mode-line                                 (:background gruvbox-dark2 :foreground gruvbox-light0 :box nil))
     (mode-line-inactive                        (:background gruvbox-dark1 :foreground gruvbox-light4 :box nil))
     (fringe                                    (:background gruvbox-dark1))
     ...
     (helm-delete-async-message                 (:foreground gruvbox-bright_yellow))
     ...
     (helm-buffer-archive                       (:foreground gruvbox-bright_yellow))
     (helm-buffer-directory                     (:foreground gruvbox-bright_blue))
     (helm-buffer-file                          (:inherit 'default))
     (helm-buffer-not-saved                     (:foreground gruvbox-faded_red))
     (helm-buffer-process                       (:foreground gruvbox-gray))
     ...
     (helm-ff-dotted-directory                  (:foreground gruvbox-gray))
     ...
     (helm-selection                            (:background gruvbox-dark1))
     ...
     (org-level-2                               (:foreground gruvbox-bright_aqua))
     (org-level-3                               (:foreground gruvbox-bright_purple))
     (org-level-4                               (:foreground gruvbox-bright_green))
     (org-level-5                               (:foreground gruvbox-bright_yellow))
     (org-level-6                               (:foreground gruvbox-bright_orange))
     (org-level-7                               (:foreground gruvbox-faded_blue))
     (org-level-8                               (:foreground gruvbox-faded_aqua))
     ...
     (org-archived                              (:inherit 'font-lock-comment-face :weight 'bold))
     ...
     (org-block                                 (:background gruvbox-dark0))
     (org-block-begin-line                      (:background gruvbox-dark0_soft))
     (org-block-end-line                        (:background gruvbox-dark0_soft))
